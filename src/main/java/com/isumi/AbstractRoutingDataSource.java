 ...
 *
 * @author Juergen Hoeller,Hikin Yao
...
public abstract class AbstractRoutingDataSource extends AbstractDataSource
    ...
    protected Map targetDataSources;

    protected Object defaultTargetDataSource;

    protected DataSourceLookup dataSourceLookup = new JndiDataSourceLookup();

    protected Map resolvedDataSources;

    protected DataSource resolvedDefaultDataSource;
    ...
    public void afterPropertiesSet() {
        ...
        if (this.defaultTargetDataSource != null) {
            this.resolvedDefaultDataSource = resolveSpecifiedDataSource(
